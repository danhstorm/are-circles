  ...
  return [
    {
      ...
      mediaEnabled: false,
      soundEnabled: true,
      musicInstruments: { pling: true, mid1: false, mid2: false, pad: true, drums: false },
      presetTemplates: [0],
      cycleIntervalMin: 0,
      cycleIntervalMax: 0,
    },
    {
      ...
      mediaEnabled: false,
      soundEnabled: false,
      musicInstruments: { pling: true, mid1: true, mid2: false, pad: true, drums: false },
    ...
    },
    {
      ...
      mediaEnabled: true,
      soundEnabled: false,
      musicInstruments: { pling: true, mid1: true, mid2: true, pad: true, drums: false },
      presetTemplates: [1, 2, 8],
      cycleIntervalMin: 30,
      cycleIntervalMax: 60,
    },
